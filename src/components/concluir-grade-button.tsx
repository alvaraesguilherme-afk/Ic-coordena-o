...
import { concluirGradeMidia } from "@/app/actions/escala-midia";
import { CheckIcon } from "@/components/icons";

export function ConcluirGradeButton({ ano, mes }: { ano: number; mes: number }) {
      ...
      <button
        ...
        onClick={() => {
          ...
          startTransition(async () => {
            const res = await concluirGradeMidia(ano, mes);
            setResultado(
              res.message === "success"
