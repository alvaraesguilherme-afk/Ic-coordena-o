...
export const SIDEBAR_NAV_CLASSNAME =
  "fixed inset-x-0 bottom-0 z-30 flex items-center justify-around border-t border-white/10 bg-white/[.06] backdrop-blur-xl px-2 py-2 sm:relative sm:inset-auto sm:w-20 sm:shrink-0 sm:flex-col sm:justify-start sm:gap-2 sm:border-t-0 sm:border-r sm:bg-white/[.04] sm:px-0 sm:py-6";
